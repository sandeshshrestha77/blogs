...
const BlogCard = ({
  ...
  return <Link to={`/blog/${slug}`} className="group flex flex-col bg-zinc-900/50 rounded-xl overflow-hidden shadow-lg transition-all duration-300 
      ...
      <div className="relative aspect-[16/9] overflow-hidden bg-zinc-800">
        <img src={image || "https://source.unsplash.com/1200x800/?technology"} alt={imageAlt} className="object-cover w-full h-full transition-transform duration-700 group-hover:scale-110" loading="lazy" width="600" height="338" />
      ...
      <div className="flex flex-col flex-grow p-4 sm:p-6 px-[16px] rounded">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-xs sm:text-sm text-gray-500 mt-auto pt-3 border-t border-zinc-800/50 gap-2 sm:gap-3">
          {author && <div className="flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-3">
            ...
            {read_time && <div className="flex items-center gap-1">
