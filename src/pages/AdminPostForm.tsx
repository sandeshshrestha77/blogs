                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="border-gray-300 bg-white text-gray-800 focus:ring-2 focus:ring-[#2271b1] focus:border-[#2271b1] placeholder-gray-400 text-lg font-medium"
                      />
                    ...
                    <div>
                      ...
                      <div className="flex">
                        ...
                        <Input
                          ...
                          className="rounded-l-none border-gray-300 bg-white text-gray-800 focus:ring-2 focus:ring-[#2271b1] focus:border-[#2271b1] placeholder-gray-400"
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <ReactQuill
                          ...
                          modules={modules}
                          formats={formats}
                          className="border-0 rounded-md overflow-hidden text-gray-800"
                        />
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <Input
                    ...
                    className="border-gray-300 bg-white text-gray-700 file:mr-4 file:py-2 file:px-4
                  ...
                  {imagePreview ? (
                    <div className="mt-4 relative">
                      <img
                        src={imagePreview}
                        alt="Preview"
                        className="w-full max-h-[200px] object-cover rounded-md border border-gray-300"
                      />
                      <Button
                        type="button"
                        variant="destructive"
                      ...
                      <div className="mt-2">
                        ...
                        <Input
                          ...
                          className="mt-1 border-gray-300 bg-white text-gray-800 focus:ring-2 focus:ring-[#2271b1] focus:border-[#2271b1] placeholder-gray-400"
                        />
                      </div>
                    </div>
                  ) : (
            ...
            <Card className="bg-white shadow-sm border border-gray-200">
              ...
              <CardContent className="p-6">
                <Textarea
                  ...
                  className="border-gray-300 bg-white text-gray-800 focus:ring-2 focus:ring-[#2271b1] focus:border-[#2271b1] placeholder-gray-400 min-h-[100px]"
                />
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Input
                      ...
                      value={formData.date}
                      onChange={handleChange}
                      className="w-auto border-gray-300 bg-white text-gray-800 focus:ring-2 focus:ring-[#2271b1] focus:border-[#2271b1]"
                    />
                  </div>
                  ...
                  <div className="pt-2">
                    <Button
                      ...
                      className="w-full bg-[#2271b1] hover:bg-[#135e96] text-white"
                      disabled={isLoading}
                    >
                      {isLoading ? (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="border-gray-300 bg-white text-gray-800 focus:ring-2 focus:ring-[#2271b1] focus:border-[#2271b1] placeholder-gray-400"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      maxLength={160}
                      className="border-gray-300 bg-white text-gray-800 focus:ring-2 focus:ring-[#2271b1] focus:border-[#2271b1] placeholder-gray-400 min-h-[80px]"
                    />
                    <div className="flex justify-between text-xs text-gray-500 mt-1">
